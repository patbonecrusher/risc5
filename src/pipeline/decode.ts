...
export class Decode extends PipelineStage {
    ...
    compute(): void {
        if (!this.shouldStall()) {
            ...
            this.imm11_0Next = (this.instructionNext >>> 20) & 0xfff; // to handle javascript signed weirdness
            this.funct7Next = (this.instructionNext >>> 25) & 0x7f; // to handle javascript signed weirdness
